...
void setup() {
  ...
  if (dbFile) {
    ...
    dbFile.println("timestamp,A0,A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,A11,A12,A13,ID1,ID2,F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,F11,F12,2F1,2F2,2F3,2F4,2F5,2F6,2F7,2F8,2F9,2F10,2F11,2F12");
